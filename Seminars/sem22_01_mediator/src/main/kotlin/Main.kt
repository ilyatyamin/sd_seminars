...
fun main(args: Array<String>) {
    ...
    var vendingMachine = VendingMachine(state)

    val coinSlot = CoinSlot(vendingMachine);
    val buyCoffeeButton = BuyCoffeeButton(vendingMachine)
    val buyTeaButton = BuyTeaButton(vendingMachine)
    val returnCoinButton = ReturnCoinButton(vendingMachine)
