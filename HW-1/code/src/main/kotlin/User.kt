...
class User {
    ...
    constructor(log: String, passw: String) {
        login = log
        password = passw
    }
    ...
    fun tryToEnter(loginEnter: String, passwEnter: String): Boolean {
        return login == loginEnter && password == passwEnter
    }
}
...
internal object UsersDataSerializer : KSerializer<String> {
    ...
    override fun serialize(encoder: Encoder, value: String) {
        ...
        val string = Encryptor.encryptThis(value).toString()
    ...
    override fun deserialize(decoder: Decoder): String {
        ...
        return Encryptor.decrypt(string).toString()
    }
}